...
zone.Tomb_of_Sargeras = 1147			-- Tomb of Sargeras
	...
	-- The League of Arathor 509
		RPH_AddInstance(509, 4, 8, 461, 10)
		RPH_AddInstance(509, 4, 8, 461, 100)
	...
	-- Horde Forces
	-- The Defilers 510
		RPH_AddInstance(510, 4, 8, 443, 35)
		RPH_AddInstance(510, 4, 8, 443, 105)
	-- Frostwolf Clan 729
	...
	-- The Klaxxi 1337
		...
		RPH_AddQuest(1337, 4, 8, 99, 260)
		RPH_AddQuest(1337, 4, 8, 99, 390)
		RPH_AddQuest(1337, 1, 8, 31232, 500)
		RPH_AddQuest(1337, 1, 8, 31271, 500)
		RPH_AddQuest(1337, 1, 8, 31238, 500)
		RPH_AddQuest(1337, 1, 8, 31109, 500)
		RPH_AddQuest(1337, 1, 8, 31216, 125)
		RPH_AddQuest(1337, 1, 8, 31237, 500)
		RPH_AddQuest(1337, 1, 8, 31231, 125)
		RPH_AddQuest(1337, 1, 8, 31111, 500)
		RPH_AddQuest(1337, 1, 8, 31509, 500)
		RPH_AddQuest(1337, 1, 8, 31494, 500)
		RPH_AddQuest(1337, 1, 8, 31272, 125)
		RPH_AddQuest(1337, 1, 8, 31024, 500)
		RPH_AddQuest(1337, 1, 8, 31598, 500)
		RPH_AddQuest(1337, 1, 8, 31507, 130)
		RPH_AddQuest(1337, 1, 8, 31235, 250)
		RPH_AddQuest(1337, 1, 8, 31504, 250)
		RPH_AddQuest(1337, 1, 8, 31234, 250)
		RPH_AddQuest(1337, 1, 8, 31510, 250)
		RPH_AddQuest(1337, 1, 8, 31496, 250)
		RPH_AddQuest(1337, 1, 8, 31233, 250)
		RPH_AddQuest(1337, 1, 8, 31506, 250)
		RPH_AddQuest(1337, 1, 8, 31503, 250)
		RPH_AddQuest(1337, 1, 8, 31487, 250)
		RPH_AddQuest(1337, 1, 8, 31508, 250)
		RPH_AddQuest(1337, 1, 8, 31599, 250)
		RPH_AddQuest(1337, 1, 8, 31269, 250)
		RPH_AddQuest(1337, 1, 8, 31505, 250)
		RPH_AddQuest(1337, 1, 8, 31502, 250)
		RPH_AddQuest(1337, 1, 8, 32659, 350)
	...
	-- Chee Chee 1277
		RPH_AddQuest(1277, 1, 8, 30471, 1400)
		RPH_AddItems(1277, 1, 8, 900, {[79265] = 1})
		RPH_AddQuest(1277, 1, 8, 30402, 1800, {[74864] = 5, [74839] = 5})
		RPH_AddItems(1277, 1, 8, 1800, {[74647] = 5})
		RPH_AddQuest(1277, 1, 8, 30324, 2000)
	-- Ella 1275
		RPH_AddQuest(1275, 1, 8, 30474, 1400)
		RPH_AddItems(1275, 1, 8, 900, {[79266] = 1})
		RPH_AddQuest(1275, 1, 8, 30386, 1800, {[74857] = 5})
		RPH_AddItems(1275, 1, 8, 1800, {[74651] = 5})
		RPH_AddQuest(1275, 1, 8, 30327, 2000)
	-- Farmer Fung 1283
		RPH_AddQuest(1283, 1, 8, 30475, 1400)
		RPH_AddItems(1283, 1, 8, 900, {[79268] = 1})
		RPH_AddQuest(1283, 1, 8, 30421, 1800, {[74839] = 5})
		RPH_AddItems(1283, 1, 8, 1800, {[74654] = 5})
		RPH_AddQuest(1283, 1, 8, 30317, 2000)
	-- Fish Fellreed 1282
		RPH_AddQuest(1282, 1, 8, 30473, 1400)
		RPH_AddItems(1282, 1, 8, 900, {[79266] = 1})
		RPH_AddQuest(1282, 1, 8, 30427, 1800, {[74865] = 10})
		RPH_AddItems(1282, 1, 8, 1800, {[74655] = 5})
		RPH_AddQuest(1282, 1, 8, 30326, 2000)
	-- Gina Mudclaw 1281
		RPH_AddQuest(1281, 1, 8, 30479, 1400)
		RPH_AddItems(1281, 1, 8, 900, {[79268] = 1})
		RPH_AddQuest(1281, 1, 8, 30390, 1800, {[74856] = 5})
		RPH_AddItems(1281, 1, 8, 1800, {[74644] = 5})
		RPH_AddQuest(1281, 1, 8, 30322, 2000)
	-- Haohan Mudclaw 1279
		RPH_AddQuest(1279, 1, 8, 30477, 1400)
		RPH_AddItems(1279, 1, 8, 900, {[79264] = 1})
		RPH_AddQuest(1279, 1, 8, 30414, 1800, {[74833] = 5})
		RPH_AddItems(1279, 1, 8, 1800, {[74642] = 5})
		RPH_AddQuest(1279, 1, 8, 30319, 2000)
	-- Jogu the Drunk 1273
		RPH_AddQuest(1273, 1, 8, 30478, 1400)
		RPH_AddItems(1273, 1, 8, 900, {[79267] = 1})
		RPH_AddQuest(1273, 1, 8, 30439, 1800, {[74841] = 10})
		RPH_AddItems(1273, 1, 8, 1800, {[74643] = 5})
		RPH_AddQuest(1273, 1, 8, 30321, 2000)
	-- Old Hillpaw 1276
		RPH_AddQuest(1276, 1, 8, 30476, 1400)
		RPH_AddItems(1276, 1, 8, 900, {[79265] = 1})
		RPH_AddQuest(1276, 1, 8, 30396, 1800, {[74837] = 5, [74841] = 10})
		RPH_AddItems(1276, 1, 8, 1800, {[74649] = 5})
		RPH_AddQuest(1276, 1, 8, 30318, 2000)
	-- Sho 1278
		RPH_AddQuest(1278, 1, 8, 30472, 1400)
		RPH_AddItems(1278, 1, 8, 900, {[79267] = 1})
		RPH_AddQuest(1278, 1, 8, 30408, 1800, {[74856] = 5, [74848] = 10})
		RPH_AddItems(1278, 1, 8, 1800, {[74645] = 5})
		RPH_AddQuest(1278, 1, 8, 30325, 2000)
	-- Tina Mudclaw 1280
		RPH_AddQuest(1280, 1, 8, 30470, 1400)
		RPH_AddItems(1280, 1, 8, 900, {[79264] = 1})
		RPH_AddQuest(1280, 1, 8, 30433, 1800, {[74859] = 5, [74843] = 10})
		RPH_AddItems(1280, 1, 8, 1800, {[74652] = 5})
